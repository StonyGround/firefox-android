...
class AppletFragment : BaseBrowserFragment(), UserInteractionHandler {
    ...
    /**
     * Updates the last time the user was active on the [AppletFragment].
     * This is useful to determine if the user has to start on the [HomeFragment]
     * or it should go directly to the [AppletFragment].
     */
    @VisibleForTesting
